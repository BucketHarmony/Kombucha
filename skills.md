...
- Reverse at 80% has R-wheel bias in the PID overshoot phase, NOT at all durations. 500ms=1.000 (symmetric, tick 502), 800ms=0.765 (most asymmetric, tick 500), 1200ms=0.876 (recovering, tick 501). The asymmetry lives in the ~600-1000ms post-startup window where PID overshoots. At 500ms both wheels are still ramping together; at 1200ms+ the overshoot is amortized. At longer durations (2000ms+) reverse may still be acceptable.
...
- 90-degree right turn at 80% power: L=1.04 R=-1.04 for 1920ms. Updated calibration (tick 466): 1920ms=91.5deg avg. Five-point reference: 1000ms=41deg (tick 502), 1750ms=67deg, 1850ms=85deg, 1920ms=91.5deg, 1950ms=93deg. Rate is non-linear. Old 100% power reference: L=1.3 R=-1.3 for 600ms.
